...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-WO377KTJ.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-SLPVS7HS.js";
import {
  require_react_dom
...
var TooltipProvider = __name8((props) => {
  const {
    __scopeTooltip,
...
var TooltipTrigger = React9.forwardRef(
  __name8(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name8((props) => {
...
var TooltipContent = React9.forwardRef(
  __name8(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React9.forwardRef(__name8(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React9.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name8((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name8((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React9.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name8((event) => {
        const target = event.target;
...
var TooltipContentImpl = React9.forwardRef(
  // blank line to reduce diff noise
  __name8(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React9.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name8((event) => {
...
var TooltipArrow = React9.forwardRef(
  __name8(function TooltipArrow2(props, forwardedRef) {
...
__name8(getExitSideFromRect, "getExitSideFromRect");
...
__name8(getPaddedExitPoints, "getPaddedExitPoints");
...
__name8(getPointsFromRect, "getPointsFromRect");
...
__name8(getHullPresorted, "getHullPresorted");
